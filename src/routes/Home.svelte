...
onMount(() => {
  initTE({ Dropdown, Sidenav, Ripple });
});
</script>
...
<body>
  ...
  <ul
    ...
    <nav
      id="main-navbar"
      class="fixed left-0 right-0 top-0 flex w-full flex-nowrap items-center justify-between bg-white py-[0.6rem] text-gray-500 shadow-lg hover:text-gray-700 focus:text-gray-800  dark:bg-zinc-800 lg:flex-wrap lg:justify-start xl:pl-60"
      data-te-navbar-ref>
      <!-- Container wrapper -->
      <div
