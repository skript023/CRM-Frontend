<script lang="ts">
    ...
    onMount(async () => {
        const res = fetch('https://crm-backend.glitch.me/user/create', {
            method: 'POST',
            headers: {
...
<div class="h-auto mx-auto py-12 mt-12 w-1/2 justify-center items-center">
    <div class="p-10 xs:p-0 mx-auto md:w-full md:max-w-xl border-2 border-gray-800 bg-gray-800 mt-12">
        ...
        <form>
            ...
            <div class="relative z-0 w-full mb-6 group">
                <input type="text" name="floating_email" id="username" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
